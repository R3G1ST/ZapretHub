...
public class DiscordRpcService : IDisposable
{
    ...
    {
        LargeImageKey  = "zapprethub_logo",
        LargeImageText = "ZapretHub"
    };

    private static DiscordRPC.Button[] Btns() =>
    [
        new DiscordRPC.Button { Label = "GitHub", Url = "https://github.com/R3G1ST/ZapretHub" },
        new DiscordRPC.Button { Label = "Telegram канал", Url = "https://t.me/ZapretHubRuBi" }
    ];
    ...
    public void SetMainMenu()
        => Set("Чилит в ZapretHub", $"Пинг: {P} · Запущен {Up()}");
    ...
    public void SetAllGood(bool zapret, bool tgws)
        => Set($"Чилит в ZapretHub с пингом {P}", "ZapretHub работает");
