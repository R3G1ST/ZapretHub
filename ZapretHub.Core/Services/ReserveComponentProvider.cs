...
{
    private const string ManifestResourceName = "ZapretHub.Assets.Fallback.metadata.json";
    private const string ZapretResourceName = "ZapretHub.Assets.Fallback.zapret-fallback.zip";
    private const string TgWsProxyResourceName = "ZapretHub.Assets.Fallback.tgwsproxy-fallback.exe";
